import { a as brands, c as metrics, d as phone_iphone_default, f as AnnouncementBar, i as useCart, l as products, n as BottomNav, o as comparable, r as Header, s as lkr, t as Footer, u as phone_samsung_default } from "./Footer-Bttx9B3v.js";
import { useMemo, useState } from "react";
import { jsx, jsxs } from "react/jsx-runtime";
import { AnimatePresence, motion } from "motion/react";
import { ArrowLeftRight, ArrowRight, BatteryFull, Calculator, Check, ChevronDown, Cpu, CreditCard, HardDrive, MemoryStick, Plus, RefreshCcw, ShieldCheck, Star, Truck } from "lucide-react";
//#region src/components/apex/Hero.tsx
function Hero() {
			...
			children: [/* @__PURE__ */ jsxs(motion.div, {
				...
				children: [
					/* @__PURE__ */ jsxs("span", {
						...
						children: [/* @__PURE__ */ jsx(ShieldCheck, { className: "size-3.5" }), " Official Sri Lanka Warranty"]
					}),
					/* @__PURE__ */ jsxs("h1", {
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs(motion.a, {
							...
							children: ["Explore Flagships ", /* @__PURE__ */ jsx(ArrowRight, { className: "size-4" })]
							...
							children: [/* @__PURE__ */ jsx(Calculator, { className: "size-4" }), " Trade-In Calculator"]
						})]
					}),
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("span", {
							...
							children: [/* @__PURE__ */ jsx(Truck, { className: "size-4 text-primary" }), " Island-wide express"]
						}), /* @__PURE__ */ jsxs("span", {
							className: "inline-flex items-center gap-2",
							children: [/* @__PURE__ */ jsx(CreditCard, { className: "size-4 text-primary" }), " 0% installments"]
						})]
					})
				]
			}), /* @__PURE__ */ jsx(motion.div, {
					...
					children: [
						...
						/* @__PURE__ */ jsx("div", {
							...
							children: [{
								...
								n: "Galaxy S24 Ultra",
								p: "LKR 399,900"
							}].map((d, idx) => /* @__PURE__ */ jsxs(motion.div, {
								animate: { y: [
									0,
									idx === 0 ? -8 : -12,
									0
...
//#endregion
//#region src/components/apex/BrandPills.tsx
...
//#endregion
//#region src/components/apex/ProductGrid.tsx
		...
		children: [/* @__PURE__ */ jsxs("button", {
					...
					children: [
						...
						return /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("p", {
								...
								children: [
									/* @__PURE__ */ jsx(Icon, { className: "size-3 text-primary" }),
									" ",
									label
								]
							}), /* @__PURE__ */ jsx("p", {
			...
			children: [
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsx(Star, { className: "size-3 fill-primary text-primary" }),
						/* @__PURE__ */ jsx("span", {
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: added ? /* @__PURE__ */ jsx(Check, { className: "size-5" }) : /* @__PURE__ */ jsx(Plus, { className: "size-5" })
					})]
				})
			]
		})]
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("h2", {
					...
					children: ["Hot ", /* @__PURE__ */ jsx("span", {
						className: "gradient-text",
						children: "Deals"
					})]
				}), /* @__PURE__ */ jsx("p", {
				...
				children: products.map((p) => /* @__PURE__ */ jsx(ProductCard, {
					p,
					onAdd
				}, p.id))
			})]
...
//#endregion
//#region src/components/apex/Comparison.tsx
var rows = [
	{
		key: "camera",
		label: "Camera"
...
function Picker({ value, onChange, exclude, align }) {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx("select", {
			...
			children: comparable.filter((p) => p.id !== exclude).map((p) => /* @__PURE__ */ jsx("option", {
				value: p.id,
				children: p.name
			}, p.id))
		}), /* @__PURE__ */ jsx(ChevronDown, { className: "pointer-events-none absolute right-3 top-1/2 size-4 -translate-y-1/2 text-primary" })]
	});
}
function Comparison() {
			...
			children: [
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("h2", {
						className: "text-2xl font-bold sm:text-3xl",
						children: ["Head to ", /* @__PURE__ */ jsx("span", {
							className: "gradient-text",
							children: "Head"
						})]
					}), /* @__PURE__ */ jsx("p", {
						...
						children: [/* @__PURE__ */ jsx(ArrowLeftRight, { className: "size-4 text-primary" }), " Swap"]
					})]
				}),
				/* @__PURE__ */ jsxs("div", {
				...
				/* @__PURE__ */ jsx("div", {
					className: "mt-3 grid grid-cols-2 gap-3",
					children: [left, right].map((d) => /* @__PURE__ */ jsxs("div", {
						className: "glass rounded-2xl p-3 text-center",
						children: [
						...
						return /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("p", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("p", {
									...
									className: "mt-1.5",
									children: /* @__PURE__ */ jsx(Bar, { v: sa })
								})]
							}), /* @__PURE__ */ jsxs("div", {
...
//#endregion
//#region src/components/apex/Perks.tsx
var perks = [
	{
		icon: ShieldCheck,
...
function Perks() {
	return /* @__PURE__ */ jsx("section", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("h2", {
				className: "text-2xl font-bold sm:text-3xl",
				children: ["Why buy at ", /* @__PURE__ */ jsx("span", {
					className: "gradient-text",
					children: "Apex"
				})]
			}), /* @__PURE__ */ jsx("div", {
...
function Index() {
	...
	const { add } = useCart();
	const filtered = useMemo(() => brand === "All Brands" ? products : products.filter((p) => p.brand === brand), [brand]);
	return /* @__PURE__ */ jsxs("div", {
